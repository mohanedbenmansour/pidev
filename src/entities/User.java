...
public class User {
    ...
    public User(int id, String username, String email, String phone_number, String image, String nom, String prenom) {
        this.id = id;
        this.username = username;
        this.email = email;
        this.phone_number = phone_number;
    ...
    public User(int id, String username, String password, String email, String phone_number, String image, String nom, String prenom, String facebookProfil, String twitch_profil) {
        this.id = id;
        this.username = username;
        this.password = password;
        this.email = email;
    ...
    public User(String username, String password, String email, String phone_number, String image, String nom, String prenom, String facebookProfil, String twitch_profil) {
        this.username = username;
        this.password = password;
        this.email = email;
        this.phone_number = phone_number;
